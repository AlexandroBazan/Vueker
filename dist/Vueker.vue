...
export default {
  ...
  methods: {
     ...
     */
      ...
      this.calendar.weeks = this.makeWeeks(initDate);
  	},
    ...
    showCalendar: function(){
      ...
      this.calendar.right = (input.offsetWidth > 266) ? true : false;
      ...
      if ((windowHeight / 2) < inputPositions.top) {
      ...
      this.isShowlable = this.isShowlable ? false: true;
    ...
    onBlur: function(){
      ...
      body[0].addEventListener('click', function(e){
        ...
        var box = document.querySelector('#'+vm.vuekerBoxId);
        var btn = document.querySelector('#'+vm.vuekerButtonId);
    ...
    isMonth: function(month) {
      return  (month == this.calendar.month.number) ? true : false;
    },
    /**
    ...
    isDisabled: function(date) {
      ...
      if(this.minDate) {
        conditionA = (date.diff(this.mutable.minDate,'days') > -1);
      }

      if(this.maxDate) {
        conditionB = (date.diff(this.mutable.maxDate,'days') < 1);
      }
